...
//         // Down panel setup for calculator buttons
//         JPanel down = new JPanel();
//         down.setLayout(new GridLayout(6, 4, 3, 3));

//         // Button labels and their tooltips
//         String[][] buttons = {
...
//         // Create buttons, add ActionListener, and set ToolTips
//         for (String[] buttonData : buttons) {
//             JButton button = new JButton(buttonData[0]);
//             button.setToolTipText(buttonData[1]);
//             button.setFont(new Font("Arial", Font.BOLD, 18));

//             // Set background and text color for different types of buttons
//             if ("+-*/%".contains(buttonData[0])) {
//                 button.setBackground(Color.GRAY); // Orange for operators
//                 button.setForeground(Color.WHITE);
//             } else if (buttonData[0].equals("=")) {
//                 button.setBackground(Color.GRAY); // Green for the equals button
//                 button.setForeground(Color.WHITE);
//             } else if ("C CE x".contains(buttonData[0])) {
//                 button.setBackground(Color.GRAY); // Red for clear buttons
//                 button.setForeground(Color.WHITE);
//             } else {
//                 button.setBackground(Color.GRAY); // Default color for other buttons
...
//         // Adding an Image to the GridLayout
//         // Load an image (you need to have "calculator.png" in your project directory)
...
//         try {
//             // Load the image from the project's resource folder
//             ImageIcon icon = new ImageIcon(getClass().getResource("download.jpeg"));
